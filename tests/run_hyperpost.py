#!/usr/bin/env python3
"""
Wrapper script for hyperpost - runs a single configuration via command-line arguments.

Usage:
	python run_hyperpost.py --sth true --sch true --chit false --I 1 --soh true --siit true
...
def main():
	parser = argparse.ArgumentParser(
		description='Run hyperpost with a specific configuration (single subprocess call).'
	)
	...
	try:
		...
		hyperpost(inputs, outputs, maps, grid, mix_coeffs, m, m_k, t_k)
